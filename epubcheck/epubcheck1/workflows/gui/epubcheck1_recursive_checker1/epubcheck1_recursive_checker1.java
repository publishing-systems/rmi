  ...
  implements ActionListener
{
    ...
    public epubcheck1_recursive_checker1()
    {
...

        {
            ...
            this.checkProgressBar = new JProgressBar(JProgressBar.HORIZONTAL, 0, 100);
            this.checkProgressBar.setIndeterminate(true);
            this.checkProgressBar.setStringPainted(true);
            panelResults.add(this.checkProgressBar, BorderLayout.PAGE_START);
         ...
         * @todo Deregister.
         */
        RMIRegistryStarterThread starterThread = new RMIRegistryStarterThread();
        starterThread.start();

        RMIProgressServerRegistrator registrator = new RMIProgressServerRegistrator(this);
    ...
    public void check()
    {
        ...
        // The program + ".." + File.separator + ".." needs to come first, otherwise epubcheck1_recursive_checker1 gui
        // would get called instead of epubcheck1_recursive_checker1 workflow. The epubcheck1_recursive_checker1 gui
        // directory (programPath) is added so the RMI classes for connecting to the running epubcheck1_recursive_checker1
        // gui RMI server can be found and loaded.
        ProcessBuilder builder = new ProcessBuilder("java", "-classpath", programPath + ".." + File.separator + ".." + File.separator + ":" + programPath, "-Duser.language=" + getLocale().getLanguage(), "-Duser.country=" + getLocale().getCountry(), "epubcheck1_recursive_checker1", jobFile.getAbsolutePath(), tempDirectory.getAbsolutePath());
        ...
        {
            this.checkProgressDialog = new CheckProgressDialog(this);
            this.checkProgressDialog.setLocation(100, 100);
            this.checkProgressDialog.setSize(300, 150);
        }

        this.checkProgressDialog.setVisible(true);
        */

        /**
         * @todo Scanner is blocking GUI event updates. See
        ...
        try
        {
            ...
            while (scanner.hasNext() == true)
            {
                ...
                /*
                this.checkProgressDialog.revalidate();
                this.checkProgressDialog.repaint();
                */
                this.checkProgressBar.revalidate();
                this.checkProgressBar.repaint();
                revalidate();
                repaint();
            }
        ...
        /*
        this.checkProgressDialog.setVisible(false);
        */
        //setCursor(Cursor.getDefaultCursor());
    ...
    public void updateProgress(String message, int count)
    {
        ...
        if (this.checkProgressDialog != null)
        {
            if (this.checkProgressDialog.isVisible() == true)
            {
                this.checkProgressDialog.revalidate();
                this.checkProgressDialog.repaint();
            }
    ...
    private CheckProgressDialog checkProgressDialog;
