...
public class epubcheck1_recursive_checker1
{
    ...
    public int check(String args[])
    {
        ...
        /**
         * @todo Maybe the codebase and security policy features aren't needed, if the classpath gets set right.
         */
        System.setProperty("java.rmi.server.codebase", "file://" + programPath + "gui" + File.separator + "epubcheck1_recursive_checker1" + File.separator);
        System.setProperty("java.security.policy", "file://" + programPath + "gui" + File.separator + "epubcheck1_recursive_checker1" + File.separator + "rmi.policy");
        System.setSecurityManager(new SecurityManager());

        RMIProgressServerInterface progressServer = null;

        try
        {
            progressServer = (RMIProgressServerInterface) Naming.lookup("rmi://127.0.0.1:1099/epubcheck1_recursive_checker1_gui_progress_server");
        }
        ...
        for (int i = 0; i < epubFilesSize; i++)
        {
            ...
            try
            {
                progressServer.notifyProgressChange("checking");
